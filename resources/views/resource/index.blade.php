        ...
        <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <!-- <li>
                    <a data-toggle="tab" href="#syllabus">
                        <i class="purple ace-icon fa  fa-book bigger-200"></i>
                        Syllabus
                ...
                <li>
                    <a data-toggle="tab" href="#testFormat">
                        <i class="blue ace-icon fa  fa-eye bigger-200"></i>
                        Test Formats
            ...
            <div class="tab-content">
               ...
               <!--  <div id="syllabus" class="tab-pane fade">
                ...
                <div id="testFormat" class="tab-pane fade">
